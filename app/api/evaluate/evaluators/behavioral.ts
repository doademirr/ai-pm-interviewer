...
When warranted is true: set reason to "promising_but_shallow" | "interesting_thread" | "gap_to_probe"; set target_gap to a brief note under 15 words on what to probe (e.g. "what specifically did you do differently after") — this is input to question generation, not the question itself.
